...
invisible(capture.output({set.seed(2); csa(); a <- adapt.concept2.sFFLHD.R6$new(D=1,L=3,func=Vectorize(function(xx)logistic(xx,.5,15)), obj="desirability", des_func=des_func_grad_norm2_meaninv_plateau, alpha_des=10, weight_const = 1, n0=4, take_until_maxpvar_below=1, package="GauPro_kernel", design='sFFLHD', selection_method="max_des_red_all", nugget=1e-4); a$run(3)}))
```
