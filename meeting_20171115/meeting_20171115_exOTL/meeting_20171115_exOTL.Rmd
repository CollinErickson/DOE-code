...
n0 <- 3*D # 18 initial points
n_batches_to_run <- 14  # Gets up to 18+3*14=60=10*D
```



## OTL circuit, $E[g^2]$, $\alpha=1$, sFFLHD_Lflex batch 3
...
## OTL circuit, $E[g^2]$, sFFLHD_Lflex non-adaptive batch 3
