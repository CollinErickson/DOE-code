...
c1 <- compare.adaptR6$new(
  D=3,L=1,func=beambending, obj="desirability", alpha_des=1, weight_const=0, #n0=8, #take_until_maxpvar_below=1,
  package="laGP_GauPro_kernel", 
  design='given', actual_des_func='actual_des_func_grad_norm2_mean_banana', #verbose=0,#, nconsider=c(50,20,10),  nugget=1e-6, nconsider_random=c(0),
  ...
  batches=30, reps=10, 
  pass_list=list(X0=lhs::optimumLHS(n=20,k=2),
                 Xopts=Xopts,
