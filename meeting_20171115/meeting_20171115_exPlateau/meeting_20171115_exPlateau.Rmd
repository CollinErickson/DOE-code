...
actual_des_func <- actual_des_func_grad_norm2_mean_logistic_plateau #get_num_actual_des_func_grad_norm2_mean(logistic15)
n0 <- 3*D # 3 initial points
n_batches_to_run <- 6  # Gets up to 18+3*14=60=10*D
```
...
m3_runfunc <- function() {
  adapt.concept2.sFFLHD.R6$new(D=D,L=3,func=func, obj="desirability", des_func=des_func_grad_norm2_mean, 
                               ...
                               Xopts=lhs::optimumLHS(n=D*30, k=D)[sample(1:(D*30)),,drop=F]
                               )
}
