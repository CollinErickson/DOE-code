---
title: "Meeting 11/8 Example 5 quad peaks"
...
runfunc <- function(des_func, selection_method="max_des_red_all") {
  adapt.concept2.sFFLHD.R6$new(D=2,L=1,func=quad_peaks, obj="desirability", des_func=des_func, 
                               ...
                               actual_des_func=actual_des_func_grad_norm2_mean_quad_peaks, 
...
## Quad peaks, $E[g]^2 + 0.5 E[r^Tr]$,  $\alpha=0.5$
