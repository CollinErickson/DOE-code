...
runfunc <- function(des_func, selection_method="max_des_red_all") {
  adapt.concept2.sFFLHD.R6$new(D=1,L=1,func=logistic_plateau, obj="desirability", des_func=des_func, 
                               ...
                               actual_des_func=actual_des_func_grad_norm2_mean_logistic_plateau, 
