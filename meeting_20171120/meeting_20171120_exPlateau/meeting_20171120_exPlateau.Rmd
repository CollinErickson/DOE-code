---
title: "Meeting 11/20 Example Plateau"
...
nruns <- 10
D <- 1
func <- logistic_plateau
actual_des_func <- actual_des_func_grad_norm2_mean_logistic_plateau #get_num_actual_des_func_grad_norm2_mean(Plateau15)
...
## Plateau, $E[g^2]$, $\alpha=1$, sFFLHD batch 3
...
## Plateau, $E[g^2]$, $\alpha=0$, sFFLHD batch 3
...
## Plateau, $E[g^2]$, $\alpha=1$, LHS batch 3
...
## Plateau, $E[g^2]$, $\alpha=0$, LHS batch 3
...
## Plateau, $E[g^2]$, sFFLHD non-adaptive batch 3
...
## Plateau, $E[g^2]$, sobel non-adaptive batch 3
...
## Plateau, $E[g^2]$, sFFLHD picking max SE batch 3
...
## Plateau, $E[g^2]$, sFFLHD picking max SE red batch 3
...
## Plateau, $E[g^2]$, $\alpha=1$, sFFLHD batch 1
...
## Plateau, $E[g^2]$, $\alpha=0$, sFFLHD batch 1
...
## Plateau, $E[g^2]$, $\alpha=1$, LHS batch 1
...
## Plateau, $E[g^2]$, $\alpha=0$, LHS batch 1
...
## Plateau, $E[g^2]$, SMED D-adjust sFFLHD b=3
...
## Plateau, $E[g^2]$, Max w*s sFFLHD b=3
...
## Plateau, $E[g^2]$, LOOEC IntWerror sFFLHD b=3
...
## Plateau, $E[g^2]$,  LOOEC max w*s, sFFLHD b=3
