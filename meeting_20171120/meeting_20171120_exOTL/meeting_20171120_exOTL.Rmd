---
title: "Meeting 11/20 Example OTL Circuit"
...
## OTL Circuit, $E[g^2]$, $\alpha=1$, sFFLHD batch 1
...
## OTL Circuit, $E[g^2]$, $\alpha=0$, sFFLHD batch 1
...
## OTL Circuit, $E[g^2]$, $\alpha=1$, LHS batch 1
...
## OTL Circuit, $E[g^2]$, $\alpha=0$, LHS batch 1
...
## OTL, $E[g^2]$, SMED D-adjust sFFLHD b=3
...
## OTL, $E[g^2]$, LOOEC IntWerror sFFLHD b=3
...
## OTL, $E[g^2]$,  LOOEC max w*s, sFFLHD b=3
