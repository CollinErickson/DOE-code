...
if (T) {
  bh1_file <- './/compare_adaptconcept_output//notborehole_D=8_L=4_b=4_B=4_R=3_n0=20_Fold=0_Fpvar=0_S=756//object.rds'
  ...
  if (file.exists(bh1_file)) { # Load if saved, and recover
    ...
    bh1 <- compare.adaptR6$new(func='borehole', reps=3, batches=4, D=8, L=4, n0=20, 
                               ...
                               parallel=F, # always do parallel for temp_save
