...
Example 4, doing them in separate files for simplicity.
...
runfunc <- function(des_func, selection_method="max_des_red_all") {
  adapt.concept2.sFFLHD.R6$new(D=2,L=3,func=f4, obj="desirability", des_func=des_func, alpha_des=1, weight_const=0, n0=8, take_until_maxpvar_below=1, package="laGP_GauPro_kernel", design='sFFLHD', selection_method=selection_method, nugget=1e-6, actual_des_func=actual_des_func_grad_norm2_mean_f4, verbose=0, nconsider=c(50,20,10), nconsider_random=c(0))
}
```
