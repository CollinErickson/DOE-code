...
Example 2, doing them in separate files for simplicity.
...
invisible(capture.output({set.seed(5); csa(); m1e1 <- adapt.concept2.sFFLHD.R6$new(D=1,L=3,func=Vectorize(function(xx)logistic(xx,.5,15)), obj="desirability", des_func=des_func_grad_norm2_mean, alpha_des=1, weight_const=0, n0=3, take_until_maxpvar_below=1, package="GauPro_kernel", design='sFFLHD', selection_method="max_des_red_all", nugget=1e-6, actual_des_func=actual_des_func_grad_norm2_mean_logistic); m1e1$run(3, plotlastonly = T)}))
```
...
invisible(capture.output({set.seed(5); csa(); m2e1 <- adapt.concept2.sFFLHD.R6$new(D=1,L=3,func=Vectorize(function(xx)logistic(xx,.5,15)), obj="desirability", des_func=des_func_mean_grad_norm2, alpha_des=1, weight_const=0, n0=3, take_until_maxpvar_below=1, package="GauPro_kernel", design='sFFLHD', selection_method="max_des_red_all", nugget=1e-6, actual_des_func=actual_des_func_grad_norm2_mean_logistic); m2e1$run(3, plotlastonly = T)}))
```
...
invisible(capture.output({set.seed(5); csa(); m3e1 <- adapt.concept2.sFFLHD.R6$new(D=1,L=3,func=Vectorize(function(xx)logistic(xx,.5,15)), obj="desirability", des_func=get_des_func_grad_norm2_mean_alpha(alpha=.5), alpha_des=1, weight_const=0, n0=3, take_until_maxpvar_below=1, package="GauPro_kernel", design='sFFLHD', selection_method="max_des_red_all", nugget=1e-6, actual_des_func=actual_des_func_grad_norm2_mean_logistic); m3e1$run(3, plotlastonly = T)}))
```
...
invisible(capture.output({set.seed(5); csa(); m4e1 <- adapt.concept2.sFFLHD.R6$new(D=1,L=3,func=Vectorize(function(xx)logistic(xx,.5,15)), obj="desirability", des_func=get_des_func_grad_norm2_mean_alpha(alpha=.5), alpha_des=1, weight_const=0, n0=3, take_until_maxpvar_below=1, package="GauPro_kernel", design='sFFLHD', selection_method="nonadapt", nugget=1e-6, actual_des_func=actual_des_func_grad_norm2_mean_logistic); m4e1$run(3, plotlastonly = T)}))
```
